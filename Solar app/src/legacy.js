...
gltfLoader.load('need_some_space.glb', function(gltf) {
...
const marsTransformedInfo = `<b>Terraformed Mars</b><br><br>

Terraforming Mars refers to the hypothetical process of deliberately transforming the Red Planet's hostile environment into one capable of sustaining human life — warming its surface, thickening its atmosphere, and eventually introducing liquid water. Terraforming is the process of transforming a hostile, extraterrestrial environment into one suitable for human life. Mars is considered the prime candidate for this vision because we now know that Mars once harbored a thick atmosphere, flowing rivers, and quite possibly life — in many respects, millions of years ago, Mars was very similar to Earth.<br><br>

<b>Origins of the Idea</b><br>
The term "terraforming" was introduced by Jack Williamson in the short story "Collision Orbit," which appeared in the July 1942 issue of <i>Astounding Science Fiction</i>. The concept moved from science fiction into serious scientific discourse largely thanks to astronomer Carl Sagan. In a 1971 paper, "The Long Winter Model of Martian Biology: A Speculation," published in <i>Icarus</i>, Sagan explored the idea of making Mars habitable by using dark-colored plants or microorganisms to reduce the planet's albedo, leading to better absorption of sunlight to warm the surface, which would release water and carbon dioxide from the polar caps and regolith. He recognized that darkening the polar caps to trigger CO₂ release and greenhouse warming is a concept that remains central to modern Mars terraforming proposals. In 1976, NASA addressed the issue of planetary engineering officially in a study and concluded that it was possible for Mars to support life and be made into a habitable planet.<br><br>

<b>How It Would Work</b><br>
Scientists propose that terraforming Mars would unfold over centuries in phases. The process would progress in three phases: first, warming the planet; then, introducing hardy organisms to start an ecosystem; and finally, engineering a biosphere with enough oxygen to support human life. One proposed method involves releasing a huge payload of CFCs into the Martian atmosphere to trap heat from the sun, raising surface temperatures by roughly 4 degrees Celsius — enough to spark a climatic chain reaction, vaporizing CO₂ from the polar caps and eventually melting ice to provide liquid water. Another approach involves an artificial magnetosphere: through deployment of large-scale electromagnetic coils or magnetic shields in orbit or on the surface, a localized or planetary magnetic field could be created, mimicking Earth's magnetosphere — a concept proposed by Dr. James Green, former chief scientist at NASA.<br><br>

<b>Elon Musk's Vision</b><br>
Elon Musk has been one of the most vocal modern champions of making Mars a second home for humanity. SpaceX has stated that its goal is to colonize Mars to ensure the long-term survival of the human species by enabling humankind to become multiplanetary. Musk has described his vision as "terraforming Mars and really making it a nice place to be," first laying out his grand plan in a presentation titled "Making Life Multiplanetary" at the International Astronautical Congress. His roadmap involves first establishing a self-sustaining colony, then gradually transforming the planet over generations. SpaceX planned to build a crewed base on Mars — Mars Base Alpha — which it hoped would grow into a self-sufficient colony, accompanied by machines to produce fertilizer, methane, and oxygen from Mars' atmospheric nitrogen, carbon dioxide, and subsurface water ice.<br><br>

<b>Our Progress So Far</b><br>
On September 7, 2024, SpaceX announced plans to launch the first uncrewed Starship missions to Mars by 2026, sending five Starships to test whether they could reliably land intact on Mars. If successful, crewed flights were planned within approximately four years. Those first uncrewed Starships would carry an unspecified number of Tesla's bipedal Optimus robots, which would install power plants and other infrastructure, as well as scout for resources such as water ice. However, the path has proven difficult. Multiple Starship test flights failed in 2025, and in February 2026, Elon Musk announced a delay in Mars ambitions of "about five to seven years" in order to focus first on lunar missions, citing Starship's development as proving harder and slower than projected. Key technical hurdles remain: SpaceX transferred a modest 5 metric tons of propellant between two internal tanks during a 2024 test as an encouraging proof of concept, but a full-scale demonstration of transferring large amounts of cryogenic propellant between two separate spacecraft in orbit — essential for a Mars mission — remained undemonstrated as of early 2026.<br><br>

Despite the setbacks, the dream endures. Research indicates that complete habitability for human flourishing would likely take at least a century — but every rover, every Starship test, and every scientific study brings humanity one step closer to the most ambitious transformation in history.<br><br>

<span style="font-size:10px;opacity:0.6;">Sources: Wikipedia – Terraforming; Wikipedia – SpaceX Mars Colonization Program; NASA / AIP Publishing – Terraforming Mars, Physics Today; Terraforming World Initiative – Carl Sagan; Space Settlement Progress – Perspectives on Mars Terraforming; Aerospace America – A Closer Look at SpaceX's Mars Plan; NasaCityLights – SpaceX Starship Mars Mission 2026</span>`;
...
window.addEventListener("click", e => {
  ...
  if (spaceshipViewActive || keplerSystemViewActive || andromedaViewActive) return;
...
function enterGalacticView() {
  ...
  if (andromedaViewActive) exitAndromedaView();
...
const MILKY_WAY_INFO = `
<b style="font-size:15px;letter-spacing:0.5px;">The Milky Way Galaxy</b><br><br>
The Milky Way is our home galaxy — a barred spiral galaxy approximately 100,000 light-years in diameter and about 1,000 light-years thick. It is a gravitationally bound collection of stars, swirling in a spiral through space, and is one of an estimated 2 trillion galaxies in the observable universe.<br><br>
The Milky Way formed approximately 14 billion years ago and contains stars, clouds of dust and gas called nebulae, planets, and asteroids. Stars, dust, and gas fan out from the center of the galaxy in long, spiraling arms.<br><br>
The Milky Way's spiral structure is dominated by two major arms — Scutum-Centaurus and Perseus — wrapping off the ends of a central bar of stars. Two additional minor arms, Norma and Sagittarius, are less distinct and primarily filled with gas and pockets of star-forming activity.<br><br>
It is estimated that the Milky Way contains around 100 to 400 billion stars, including our own Sun. Our solar system sits about 26,000 light-years from the galactic center, and it takes approximately 250 million years for our Sun — and Earth along with it — to complete one full revolution around that center.<br><br>
At the very heart of the galaxy lies a supermassive black hole known as Sagittarius A* (Sgr A*). Sgr A* has a mass about 4 million times that of our Sun. Because of its relative proximity to Earth at 26,000 light-years, researchers can observe how matter interacts with the black hole.<br><br>
The Milky Way is surrounded by a stellar halo roughly 300,000 light-years across, and an even larger dark matter halo approximately one million light-years across — about ten times the width of the galaxy's disk.<br><br>
The Milky Way resides in a neighborhood of over 50 galaxies called the Local Group, whose members range from small dwarf galaxies to Andromeda, our nearest large galactic neighbor.<br><br>
...
const KEPLER_22B_INFO = `<b>Kepler-22b — Earth's Distant Twin?</b><br><br>
...
<b>How We Found It</b><br>
Launched in 2009, the Kepler spacecraft measured the light output of 150,000 stars simultaneously, analyzing the data from each star to look for periodic drops in the light curve — drops that could indicate the presence of an orbiting planet passing in front of its host star, blocking some of its light. This method is called a transit. Kepler-22b's detection was confirmed after observing three transits across its host star, each causing a periodic dip in brightness. Its existence was officially confirmed on December 5, 2011, and the scientific world took notice. At the press conference, NASA's Pete Worden, director of Ames Research Center, declared: "We're getting closer and closer to discovering the so-called 'Goldilocks planet.'"<br><br>

<b>Size — Bigger Than Home</b><br>
Kepler-22b's radius is roughly twice that of Earth — more precisely, about 2.1 Earth radii as of the most recent 2023 revision. That makes it what scientists classify as a "Super-Earth," though the name is a little misleading, since it doesn't necessarily mean it's a rocky world like ours. Its mass is estimated at around 9.1 Earth masses, though this figure remains uncertain — the true mass may be anywhere in a wide range, and pinning it down precisely with current instruments has proven difficult. Its mass is likely somewhere between that of Earth and Neptune, making it either a Super-Earth or a mini-Neptune.<br><br>

<b>Its Star — A Familiar Sun</b><br>
Kepler-22b's host star, Kepler-22, is a G-type star — the same class as our own Sun — that is 3% less massive than the Sun and 2% smaller in volume. Its surface temperature is 5,518 K, compared to the Sun's 5,778 K, making it slightly cooler. The star is about 4 billion years old, compared to the Sun's 4.6 billion years. From the surface of Kepler-22b, if you could stand there and look up, the sight would feel eerily familiar — the star would look very much like our own Sun: similar mass and size, just a little bit fainter. However, the star's apparent magnitude is 11.5, meaning it is too dim to be seen with the naked eye from Earth.<br><br>

<b>The Goldilocks Orbit</b><br>
Kepler-22b lies about 15% closer to its parent star than Earth does to the Sun, which would make it significantly hotter — were it not balanced out by the fact that its host star shines 25% less brightly than our Sun. These two factors neatly cancel each other out, placing Kepler-22b right in the sweet spot — the habitable zone, sometimes called the Goldilocks Zone — where conditions are just right: not too hot for water to evaporate, and not too cold for it to freeze. It completes one full orbit of its star every 289.9 days, sitting at a distance of 0.812 AU from its star — a year on Kepler-22b is only about 75 days shorter than a year on Earth.<br><br>

<b>Temperature — Possibly Like a Mediterranean Day</b><br>
This is where Kepler-22b starts to feel genuinely exciting. In the absence of any atmosphere, the planet's equilibrium temperature would be approximately 279 K (6°C) — just above freezing. If the atmosphere provides a greenhouse effect similar in magnitude to Earth's, the average surface temperature would be around 295 K (22°C). That's roughly 72 degrees Fahrenheit — a mild, pleasant spring day. Of course, the atmosphere remains undetected and unknown. If the atmosphere had a greenhouse effect as extreme as Venus, the temperature would rocket to 733 K (460°C) — hot enough to melt lead. The actual temperature of Kepler-22b therefore sits somewhere between a pleasant ocean world and a scorched hellscape, and we simply don't yet know which.<br><br>

<b>A World of Water?</b><br>
Scientists believe Kepler-22b is likely a "water world," similar to the exoplanet Gliese 1214 b, with substantial quantities of water in the form of surface oceans. The high surface gravity would make it difficult for large land areas to form, and its location from its star would allow vast amounts of liquid water to form on the surface. Imagine an entire planet of deep, endless ocean — no continents, no mountain ranges breaking the horizon, just water stretching to the edge of sight in every direction, under a slightly dimmer sun in an alien sky. NASA itself describes it as "a possible ocean world orbiting in the habitable zone — the region around a star where the temperature is right for liquid water, a requirement for life on Earth."<br><br>

<b>Could There Be Life?</b><br>
This is the question that has captivated scientists and dreamers alike since its discovery. The honest answer is: we don't know. Recent estimates suggest that Kepler-22b has more than a 95% probability of being located in the empirical habitable zone. But being in the habitable zone is only one piece of the puzzle. Scientists don't yet know if the planet has a predominantly rocky, gaseous, or liquid composition, and without knowing that, it's very hard to assess whether life as we know it could take hold. An atmosphere on Kepler-22b has not been detected, and it is unlikely to be detectable with any current instrumentation. Even the James Webb Space Telescope, our most powerful eye on the cosmos, may not be able to peer deeply enough into a system this far away to read its atmospheric fingerprints.<br><br>

<b>A Historic Milestone</b><br>
Whatever Kepler-22b ultimately turns out to be, its discovery changed the story of humanity's search for other worlds. Before its discovery, no confirmed exoplanet had been found in a Sun-like star's habitable zone. Its discovery was pivotal in demonstrating the effectiveness of the transit photometry method in identifying Earth-size planets within habitable zones, and it inspired a series of subsequent missions and analyses focused on habitable exoplanets. It proved that Goldilocks worlds are not just the stuff of science fiction — they exist, they orbit sun-like stars, and our galaxy is full of possibilities we have only begun to explore.<br><br>

<span style="font-size:10px;opacity:0.6;">Sources: NASA Science – Kepler-22b Exoplanet Catalog; Wikipedia – Kepler-22b; NOAA Science on a Sphere – Exoplanet Kepler-22b; Space.com – Kepler-22b Facts About Exoplanet in Habitable Zone; AAAS – What We Know and Don't Know About Kepler-22b; BBC Sky at Night Magazine – Kepler-22b, First Planet in the Habitable Zone; WorldAtlas – Kepler-22b</span>`;
...
// ── The Andromeda Galaxy view ─────────────────────────────────────────────────
// A standalone scene with its own skybox. The Andromeda galaxy itself will be
// added here later; for now it's just the starfield backdrop you can look around.
let andromedaViewActive = false;
let andromedaScene      = null;
let andromedaCamera     = null;
let andromedaControls   = null;
let andromedaGalaxyPivot = null;  // spins the galaxy (model + disc) slowly
let andromedaRadius      = 3780;  // galaxy visual radius (refined once the GLB loads)
let andromedaStarfield   = null;  // custom procedural star field (replaces the 8K skybox)

// Build a custom, resolution-independent star field: thousands of additive,
// soft-edged star points (varied colour/size, with a denser galactic band) plus a
// few faint coloured nebula clouds for depth. Because the stars are GL points with
// a smooth sprite they stay crisp at any zoom — no fixed-resolution image to soften.
function buildAndromedaStarfield() {
  const group = new THREE.Group();
  const R = SKYBOX_RADIUS * 0.9;

  // Soft round star sprite (radial gradient → glowing dot, not a square)
  ...
  // Stellar colours: weighted toward white, with blue, yellow, orange and red
  const palette = [
  ...
  for (let i = 0; i < COUNT; i++) {
    // Uniform spread over the whole sphere (no band/cluster)
    ...
    siz[i] = r < 0.87 ? (0.4 + Math.random()*0.7)
           : r < 0.98 ? (1.0 + Math.random()*1.0)
                       : (2.2 + Math.random()*1.8); // a few brighter beacons
  }
  ...
  // Faint coloured nebula clouds for depth and colour
  ...
  for (let n = 0; n < 8; n++) {
    ...
    let u = Math.random() * 2 - 1; const th = Math.random() * Math.PI * 2;
    const s = Math.sqrt(Math.max(0, 1 - u * u));
...
// Position the Andromeda camera to frame the galaxy (a 3/4 view from above).
function frameAndromedaCamera() {
  const R = andromedaRadius;
  andromedaCamera.position.set(0, R * 0.9, R * 2.2);
  andromedaCamera.up.set(0, 1, 0);
  andromedaControls.target.set(0, 0, 0);
  andromedaControls.update();
}

function initAndromedaScene() {
  if (andromedaScene) return;
  andromedaScene = new THREE.Scene();
  andromedaScene.background = new THREE.Color(0x01010a); // deep-space near-black

  // Custom procedural star field (replaces the 8K image skybox)
  andromedaStarfield = buildAndromedaStarfield();
  andromedaScene.add(andromedaStarfield);
  andromedaScene.add(new THREE.AmbientLight(0xffffff, 0.6));

  andromedaCamera = new THREE.PerspectiveCamera(75, innerWidth / innerHeight, 0.1, SKYBOX_RADIUS * 2);

  andromedaControls = new THREE.OrbitControls(andromedaCamera, renderer.domElement);
  andromedaControls.enableDamping = true;
  andromedaControls.dampingFactor = 0.08;
  andromedaControls.minDistance   = 1;
  andromedaControls.maxDistance   = SKYBOX_RADIUS * 0.9;
  andromedaControls.target.set(0, 0, 0);
  frameAndromedaCamera();

  // --- Andromeda galaxy: same build as the Milky Way (need_some_space.glb model
  //     + a flat galaxy-texture disc), centred at the origin in this scene. ---
  const ANDRO_SCALE = 1500;
  andromedaGalaxyPivot = new THREE.Group();   // origin-centred so the galaxy spins cleanly
  andromedaScene.add(andromedaGalaxyPivot);

  new THREE.GLTFLoader().load('need_some_space.glb', function(gltf) {
    const model = gltf.scene;
    model.scale.set(ANDRO_SCALE, ANDRO_SCALE, ANDRO_SCALE);
    model.rotation.set(0, 0, 0);
    model.renderOrder = 1;

    // Centre the model's bounding box on the origin (matches the Milky Way build)
    const box = new THREE.Box3().setFromObject(model);
    const center = box.getCenter(new THREE.Vector3());
    model.position.sub(center);
    const size = box.getSize(new THREE.Vector3());
    andromedaRadius = Math.max(size.x, size.z) / 2;
    andromedaGalaxyPivot.add(model);

    // Flat galaxy disc using androgalaxy.png (additive, like the Milky Way disc)
    const aTex = new THREE.TextureLoader().load('androgalaxy.png');
    const disc = new THREE.Mesh(
      new THREE.CircleGeometry(andromedaRadius, 128),
      new THREE.MeshBasicMaterial({
        map: aTex,
        transparent: true,
        alphaTest: 0,
    ...
    disc.renderOrder = 0;
    andromedaGalaxyPivot.add(disc);

    // Re-frame now that we know the true radius
    andromedaControls.maxDistance = Math.min(SKYBOX_RADIUS * 0.9, andromedaRadius * 6);
    frameAndromedaCamera();
  });
}

function enterAndromedaView() {
  initAndromedaScene();
  // Leave any other active view first
  if (keplerSystemViewActive) exitKeplerSystem();
  if (galacticViewActive) exitGalacticView();
  if (spaceshipViewActive) exitSpaceshipView();
  andromedaViewActive = true;
  controls.enabled = false; // stop the main OrbitControls from consuming input

  // Hide the button — we're already here
...
function exitAndromedaView() {
  andromedaViewActive = false;
  controls.enabled = true;
  document.getElementById('andromedaBtn').style.display = 'block';
}

document.getElementById('andromedaBtn').onclick = () => { enterAndromedaView(); };
...
function animate(){
  ...
  if (andromedaViewActive) {
    ...
    const aDelta = Math.min(aNow - lastFrameMs, 100);
    lastFrameMs = aNow;
    const aScale = aDelta / (1000 / 60);
    // Same spin rate as the Milky Way galaxy — static at 1× real-life speed,
    // ramping up with the speed slider.
    if (andromedaGalaxyPivot) andromedaGalaxyPivot.rotation.y += 0.000000395 * speed * aScale;
    // Star field follows the camera so it reads as an infinitely distant sky.
    if (andromedaStarfield) andromedaStarfield.position.copy(andromedaCamera.position);
    andromedaControls.update();
    renderer.render(andromedaScene, andromedaCamera);
    return;
  }
...
(function initMainMenu() {
  ...
  function openMenu() {
    ...
    if (typeof andromedaViewActive !== 'undefined' && andromedaViewActive
        && typeof exitAndromedaView === 'function') {
      try { exitAndromedaView(); } catch (e) { console.warn('exitAndromedaView failed:', e); }
    }
